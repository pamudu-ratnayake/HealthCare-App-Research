...
const Data = require('../components/SymptomListSinhala.json');


const PredictSinhala = ({ route }) => {
  ...
  const DictionaryData = ({item})=>{
    ...
    return(
        <View style={styles.container}
            ...
            <Text style = {styles.result}> {item.sinname} ඔබට ඇති බව පෙනේ</Text>
